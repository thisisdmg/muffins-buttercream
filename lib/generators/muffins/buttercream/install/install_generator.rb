    ...
    module Generators
      class InstallGenerator < ::Rails::Generators::Base
        ...
        def add_import_statement
          ...
          import_statement = "\n@import 'muffins/themes/buttercream/_style.scss';"

          if File.exist?(scss_manifest)
            append_to_file scss_manifest, import_statement, after: /\z/
          elsif File.exists?(css_manifest)
            warn "Warning:\n\nIn order to use Muffins Buttercream you need to rename your app/assets/stylesheets/application.css file to application.css.scss. Adding @import statement to the .css version anyway, which might result in an error."
